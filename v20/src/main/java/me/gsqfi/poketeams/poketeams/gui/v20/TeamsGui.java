package me.gsqfi.poketeams.poketeams.gui.v20;
...
import me.gsqfi.poketeams.poketeams.helper.v20.StorageHelper;
...
*/
    ...
    private ItemStack getPokemonItemStack(Pokemon pokemon){
        ...
        ItemStack itemStack = CraftItemStack.asBukkitCopy(SpriteItemHelper.getPhoto(pokemon));
        ItemMeta itemMeta = itemStack.getItemMeta();
